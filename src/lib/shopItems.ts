...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  },
  {
    id:          "fuse_burner",
    name:        "Fuse Burner",
    tagline:     "Double the fuse speed. End it fast.",
    description: "The fuse depletes 2× faster this round. Use it when you're holding the bag and want to end before anyone can react. Or use it against the king to force a panic yoink. One use per round — no stacking.",
    price:       0.02,
    category:    "intel",
    icon:        "Flame",
    color:       "#FF2200",

    ...
    <div className="relative z-10 flex min-h-dvh flex-col">
      ...
      <AnimatePresence mode="wait">
        {!connected ? (
          ...
          >
            {/*
              ConnectScreen does NOT receive game state props.
              Showing simulated live stats on the gate is deceptive social proof.
              Static honest value props are used instead.
            */}
            <ConnectScreen />
          </motion.div>
        ) : (
